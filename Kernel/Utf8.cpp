...
#define utf8_null 0
	...
	// Duplicate the utf8 string src by getting its size, MemoryAllocate'ing a new buffer
	// copying over the data, and returning that. Or 0 if MemoryAllocate failed.
